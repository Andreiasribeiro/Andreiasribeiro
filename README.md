...
- **Automated Contact Management Tests – JavaScript Project**: Practical contact management project completed during QA Mentorship. Includes automated tests using **Mocha** and **Mochawesome**. Focus on contact list management, test automation, and QA best practices.   
  <br>
  [Contact Management Tests](https://github.com/Andreiasribeiro/contact-management-tests/blob/main/README.md)
